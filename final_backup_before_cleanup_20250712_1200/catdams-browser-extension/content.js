...
class UltimateMessageCapture {
    ...
    queueAIMessage(text) {
        ...
        // Queue the AI message to be captured after a delay
        setTimeout(() => {
    ...
    initializePeriodicScanning() {
        ...
        console.log('[CATDAMS] Layer 4: Periodic Scanning initialized');
    }
    ...
    isMessageStable(element, text, customTimeout = null) {
        ...
        if (lastText === text) {
            ...
            // Set new timer with custom timeout for DeepSeek
