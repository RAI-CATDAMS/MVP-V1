...
def shape_for_dashboard(data):
    ...
    return {
        ...
        # Enhanced TDC AI module data (all 11 modules)
...
async def receive_event(request: Request):
    try:
        ...
        # ✅ Build 'analysis' field for dashboard.js with enhanced TDC module data
        first_enrich = enrichment_results[0] if enrichment_results else {}
        
        # Extract TDC module analysis data
        tdc_analysis = {
            "tdc_ai1_user_susceptibility": first_enrich.get("tdc_ai1_user_susceptibility", {}),
            "tdc_ai2_ai_manipulation_tactics": first_enrich.get("tdc_ai2_ai_manipulation_tactics", {}),
            "tdc_ai3_sentiment_analysis": first_enrich.get("tdc_ai3_sentiment_analysis", {}),
            "tdc_ai4_prompt_attack_detection": first_enrich.get("tdc_ai4_prompt_attack_detection", {}),
            "tdc_ai5_multimodal_threat": first_enrich.get("tdc_ai5_multimodal_threat", {}),
            "tdc_ai6_longterm_influence_conditioning": first_enrich.get("tdc_ai6_longterm_influence_conditioning", {}),
            "tdc_ai7_agentic_threats": first_enrich.get("tdc_ai7_agentic_threats", {}),
            "tdc_ai8_synthesis_integration": first_enrich.get("tdc_ai8_synthesis_integration", {}),
            "tdc_ai9_explainability_evidence": first_enrich.get("tdc_ai9_explainability_evidence", {}),
            "tdc_ai10_psychological_manipulation": first_enrich.get("tdc_ai10_psychological_manipulation", {}),
            "tdc_ai11_intervention_response": first_enrich.get("tdc_ai11_intervention_response", {})
        }
        
        # Build comprehensive analysis summary
        analysis_summary = "N/A"
        if tdc_analysis["tdc_ai1_user_susceptibility"].get("notes"):
            analysis_summary = tdc_analysis["tdc_ai1_user_susceptibility"]["notes"]
        elif tdc_analysis["tdc_ai8_synthesis_integration"].get("notes"):
            analysis_summary = tdc_analysis["tdc_ai8_synthesis_integration"]["notes"]
        elif first_enrich.get("summary"):
            analysis_summary = first_enrich.get("summary")
