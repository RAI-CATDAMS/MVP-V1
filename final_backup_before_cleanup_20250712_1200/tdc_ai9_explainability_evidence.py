...
def generate_audit_trail_comprehensive(tdc_module_outputs: Dict, conversation_context: Dict = None, session_id: str = None) -> Dict:
    ...
    modules_with_evidence = len([output for output in tdc_module_outputs.values() if output and output.get('evidence')])
    modules_with_notes = len([output for output in tdc_module_outputs.values() if output and output.get('notes')])
